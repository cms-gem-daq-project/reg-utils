# -*- coding: utf-8 -*-
#
# reg_utils documentation build configuration file, created by
...
htmlhelp_basename = "reg_utilsdoc"
...
intersphinx_mapping = {
    ...
    "reg_utils": (os.getenv("GEM_DOCS_URL") + "/docs/api/reg_utils/latest", None,),
}
